...
def upgrade() -> None:
    ...
    op.create_table('events',
        ...
        sa.Column('min_tickets_per_order', sa.Integer(), nullable=False, default=1),
        sa.Column('max_tickets_per_order', sa.Integer(), nullable=False, default=10),
    ...
    op.create_table('attendees',
        ...
        sa.Column('check_in_status', sa.Boolean(), nullable=False, default=False),
